...
<p align="center">
  <b>B</b>usan <b>T</b>oken-pruning <b>S</b>eries is a curated collection of <b>token &amp; KV-cache
  pruning methods</b> across <b>image</b>, <b>3D</b>, and <b>text</b> — on a mission to become the
...
| 💬 | **RestoreKV** 🆕 | Text | Preprint | Learned budget-matched restoration for query-agnostic KV eviction | [Page](https://paper.pnu-cvsp.com/RestoreKV/) |

## 🎯 Overview

The **Busan Token-pruning Series** is not confined to a single modality. It shares one goal —
**⚡ prune redundant tokens** for efficient inference — while each work develops its **own method**
